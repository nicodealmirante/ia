...
const DATE_BASE = [
    `Producto: Espejo Magico Selfie Mirror, Valor: en Dolares: 1500 US o en pesos sujeto al dolar. Ahora: $${dolar*1500} DESCRIPCION: nuestro espejo mágico selfie mirror cuenta con con todo lo necesario para funcionar, 
